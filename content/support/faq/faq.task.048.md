...
{{< question >}}
### ERROR: '-2146375696' is not a valid date in the 'm/d/Y' format.
...
{{< /question >}}
{{< answer >}}
Well, after investigating more and more, especially grep'ing through both local data and server data (tx.data) I found my faulty data which caused the error. I haven't figured out what caused the faulty data - who should be clear ... me Lächeln :)
