...
Here is what happened in May 2016.
This is not a complete list of all activity, just work that results in a non-trivial change.
For a full list, see the git history of all the projects.

#### Summary

The main focus for May is getting [Timewarrior](https://timewarrior.net) ready for an alpha release.
The purpose of an alpha release is to gather feedback that guides the subsequent release.
...
Additionally, the `libshared` library is being improved.
This is a Git submodule that nearly all the projects share, and helps with code reuse.
Most importantly, fixing bugs in `libshared` will fix bugs in all projects, without a lot of manual patching.
...
| 2016-05-03 | - Timewarrior: Clarified the definition and added help for intervals                                                                                                     |
|            | - Timewarrior: Added `track` command                                                                                                                                     |
|            | - Timewarrior: The `track` command delegates to `start` when no range is specified                                                                                       |
| 2016-05-05 | - Timewarrior: Added `config` command                                                                                                                                    |
...
| 2016-05-13 | - Timewarrior: Added `gaps` command                                                                                                                                      |
...
| 2016-05-14 | - libshared: `Duration` needed precision formatting that only showed hours                                                                                               |
...
|            | - OSCON 2016: [Taskwarrior stickers](https://twitter.com/taskwarrior/status/732966869762637824) on the table (Want one? Ask)                                             |
|            | - Timewarrior: The `stop` command now accepts an override stop time                                                                                                      |
...
|            | - Timewarrior: Supports `reports.<type>.summary` to control display of the summary data                                                                                  |
|            | - Timewarrior: Supports `reports.<type>.lines` to control number of lines shown per day                                                                                  |
| 2016-05-20 | - [#1827: project:ide is not  allowed](https://github.com/GothenburgBitFactory/taskwarrior/issues/1827) fixed                                                            |
|            | - [#1828: dateformat lacks a flag to display day of week](https://github.com/GothenburgBitFactory/taskwarrior/issues/1828) fixed                                         |
...
|            | - taskwarrior.org: Added [plan details](/docs/design/plans)                                                                                                              |
...
|            | database](https://github.com/GothenburgBitFactory/timewarrior/issues/10) fixed                                                                                           |
| 2016-05-28 | - Flod: Removed unsupported bootstrap badge styles in the tinderbox report                                                                                               |
...
| 2016-05-30 | - libshared: `Datetime::sameQuarter` supported, needed by Timewarrior                                                                                                    |
|            | - Task: Now supports the `QUARTER` virtual tag                                                                                                                           |
...
|            | `Started 2016-05-30T18:29:43 Current 2016-05-30T17:04:02`                                                                                                                |
...
|            | - taskwarrior.org: Added `QUARTER` virtual tag to docs                                                                                                                   |
