...
|            | - task: Implemented framework for supporting the [new recurrence model](https://github.com/GothenburgBitFactory/taskwarrior/blob/develop/docs/rfcs/recurrence.md)                                                        |
...
| 2017-04-30 | - task: Implemented new DOM resolver tree to simplify existing DOM support and enable [greater DOM support](https://github.com/GothenburgBitFactory/taskwarrior/blob/develop/docs/rfcs/recurrence.md), including formats |
