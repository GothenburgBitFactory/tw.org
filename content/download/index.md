...
| [Fedora](https://packages.fedoraproject.org/pkgs/task/task/)                          | `sudo dnf install task`                                                                                                                                                                                                          | Fedora 18                  |
...
| [FreeBSD](https://www.freshports.org/deskutils/taskwarrior)                           | To install the port:<br/>`make -C /usr/ports/deskutils/taskwarrior make install clean`<br/>To add the package:<br/>`pkg install taskwarrior`                                                                                | \-                         |
| [OpenBSD](https://cvsweb.openbsd.org/ports/productivity/taskwarrior/)                 | `doas pkg_add -i taskwarrior`                                                                                                                                                                                               | -                          |
...
| [NixOS](https://nixos.org)                                                            | `nix-env -i taskwarrior3`                                                                                                                                                                                                   | \-                         |
